  ...
  <Card className="relative overflow-hidden glass-card mb-8 shadow-xl premium-slide-right">
    ...
    <CardContent className="relative z-10">
      <div className="text-center space-y-4">
        <div className="text-4xl font-bold gradient-text">70 Banks + 40 Finance Companies</div>
        <p className="text-lg text-primary font-medium">Private, National, International partnerships</p>
        <p className="text-muted-foreground glass-card rounded-lg p-3 inline-block">
